package com.alan.universalpetcare.utils;
...
public class UrlMapping {
    ...
    public static final String COUNT_ALL_VETS = "/count/vets" ;
    ...
    public static final String VETERINARIANS = API+"/vets";
    public static final String GET_ALL_VETERINARIANS = "/get-all-vets";
    public static final String SEARCH_VETERINARIAN_FOR_APPOINTMENT = "/search-vet";
